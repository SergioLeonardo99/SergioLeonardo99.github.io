  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i>  ACTUALIZAR MASCOTAS</h4>
      </div>
...
<div class="col-lg-2">
  ...
  <div class="row">
  <div class="col-lg-2">
    <label class="pull-right">Cantidad*</label></div>
    <div class="col-lg-10">
  ...
  <div class="col-lg-2">
    <label class="pull-right">Estado*</label>
      ...
      <option value="No-disponible">No-Diponible</option>
      </select>
   </div></div><br>
   <div class="row">
   <div class="col-lg-2">
   ...
   <div class="col-lg-10">
    <img src="<?php echo $image;?>" width="120px;" class="img-responsive img-rounded" style="margin-bottom:5px;">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info" name="savechanges">Guardar Cambios</button>
      </div>
