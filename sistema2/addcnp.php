...
<head>
    ...
    <link href="../sistema2/images/lol.jpeg" rel="shortcut icon">
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy;  <a target="_blank" href="#" title="#"></a>. 2020 Buscando Huellitas. Todos Los Derechos Reservados | Hecho Por Los TresMagnificos.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
