   <div class="modal fade bs-example-modal-sm" id="loginModal"tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-sm">
                               ...
                               <h4 class="wow fadeInDown">Buscando Huellitas</h4>
                                <link rel="stylesheet" href="../css/login-style.css">
                                </div>
                               <br />
                               <center><i class="fa fa-user"></i> Bienvenido Admin</center>
                                <form class="form-horizontal wow fadeInDown" method="POST" action="adminlogin_process.php">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label wow fadeInDown">Nombre</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label wow fadeInDown">Contraseña</label>
                                            <div class="col-sm-6">
