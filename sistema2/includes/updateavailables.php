        ...
        <div class="panel panel-primary">
            <div class="panel-heading panel-title text-center wow fadeInDown">
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-list-alt"></i> Lista de mascotas</span>
            </div>
              ...
              <table class="table table-responsive table-hover table-bordered table-condensed table-striped wow fadeInDown" width="100%">
              	<thead>
                	<tr style="background-color:#000; color:#FFF;">
                    	<td style="text-align:center; width:auto;" class="wow fadeInDown">NOMBRE</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">DESCRIPCIÓN</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">PREMIO</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">ESTADO</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">IMAGEN</td>
                        <td style="text-align:center; width:auto;" class="wow fadeInDown">ACCIÓN</td>
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown"><center><a href="#updateModal<?php echo $id;?>" data-toggle="modal" data-target="#updateModal<?php echo $id;?>" class="btn btn-default">Modificar</a> | <a href="#deleteModal<?php echo $id;?>" data-toggle="modal" data-target="#deleteModal<?php echo $id;?>" class="btn btn-danger"> Eliminar</a></center></td>
                        </tr>
