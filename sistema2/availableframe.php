...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;">No.<?php echo $count;?></p></strong></center></td>
                        ...
                        <dt>Nombre:</dt> <dd><?php echo $row['name'];?></dd>
						            <dt>Descripción:</dt> <dd><?php echo $row['description'];?></dd>
                        <dt>Edad:</dt> <dd><?php echo $row['prize'];?></dd>
                        </dl></td>
                        <td style="border: 1px dashed #8c8b8b;"><button class="btn btn-success  wow fadeInDown" name="order" type="button" style="margin-top:25px;" data-toggle="modal" data-target="#orderModal<?php echo $id;?>"><i class="glyphicon glyphicon glyphicon-heart"></i> Adoptar</button></td>
                    </tr>
                     <!-- Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i>completa la informacion</h4>
      </div>
   ...
   <div class="row" id="datepickup">
    ...
    <div class="col-lg-10">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="savechanges"><i class="glyphicon glyphicon-thumbs-up"></i> Enviar</button>
      </div>
      </form>
    </div>
  </div>
